...
#define __INTERNAL_SRAM_SIZE    0x00030000
#define __SRAM_POOL             (void *)0x1FFF0000

/* Uncached area is maped to sram */
#define __UNCACHED_DATA_START_DEF   0x1FFF0000
#define __UNCACHED_DATA_SIZE_DEF    0x00030000
#define __UNCACHED_DATA_END_DEF     0x2001FFFF
...
*/
    ...
    #define BSPCFG_SCI1_BAUD_RATE             57600
#endif
...
*/
    ...
    #define BSP_DEFAULT_MAX_MSGPOOLS                          (3L)
#endif
...
*/
    ...
    #define BSP_DEFAULT_MAX_MSGQS                             (32L)
#endif
...
*/
        ...
        #define BSPCFG_FLASHX_USE_PA_RAM 1
    #endif
#else
