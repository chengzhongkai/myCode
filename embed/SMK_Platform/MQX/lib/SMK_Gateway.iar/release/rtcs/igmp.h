...
extern bool IGMP_send_report (ip_mreq *, uint16_t);

extern uint32_t IGMP_filter_add (struct ip_if *, _ip_address);
extern uint32_t IGMP_filter_rm  (struct ip_if *, _ip_address);

extern MC_MEMBER_PTR      *IGMP_member_find   (MC_MEMBER_PTR *, ip_mreq *);
extern MC_MEMBER_PTR      *IGMP_member_create (MC_MEMBER_PTR *, ip_mreq *);
...
extern uint32_t IGMP_join_group  (MC_MEMBER_PTR *, ip_mreq *, uint32_t (_CODE_PTR_ *)(MC_MEMBER_PTR *));
extern uint32_t IGMP_leave_group (MC_MEMBER_PTR *, ip_mreq *, uint32_t (_CODE_PTR_ *)(MC_MEMBER_PTR *));
