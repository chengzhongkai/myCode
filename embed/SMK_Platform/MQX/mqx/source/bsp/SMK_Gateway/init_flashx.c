...
/* flash space used by application */
    { "code",   BSP_INTERNAL_FLASH_BASE,                                        (_mem_size)__FLASHX_START_ADDR - 1 },
    { "flexram0",   (_mem_size)BSP_INTERNAL_FLEXRAM_BASE,   BSP_INTERNAL_FLEXRAM_BASE + BSP_INTERNAL_FLEXRAM_SIZE - 1 },
/* remaining free flash space */
    { "",       (_mem_size)__FLASHX_START_ADDR,                                 (_mem_size) __FLASHX_END_ADDR },
    { NULL,     0,                                                              0 }
};
