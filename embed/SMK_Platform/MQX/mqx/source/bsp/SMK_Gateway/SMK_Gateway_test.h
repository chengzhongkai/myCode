...
#ifndef _SMK_Gateway_h_
    #define _SMK_Gateway_h_  1
...
*/
#define BSP_TWR_K64F120M                     1
//#define BSP_NAME                             "TWRK64F120M"
...
#define __UNCACHED_DATA_END_DEF     0x2002FFFF
...
*/
#define BSP_LED1                    (GPIO_PORT_E | GPIO_PIN6)
#define BSP_LED2                    (GPIO_PORT_E | GPIO_PIN7)
#define BSP_LED3                    (GPIO_PORT_E | GPIO_PIN8)
#define BSP_LED4                    (GPIO_PORT_E | GPIO_PIN9)

//#define BSP_SW1                     (GPIO_PORT_C | GPIO_PIN6)
#define BSP_SW2                     (GPIO_PORT_D | GPIO_PIN6)
//#define BSP_ACCEL_IRQ               (GPIO_PORT_A | GPIO_PIN6) /* onboard accelerometer IRQ pin */

#define BSP_LED1_MUX_GPIO           (LWGPIO_MUX_E6_GPIO)
#define BSP_LED2_MUX_GPIO           (LWGPIO_MUX_E7_GPIO)
#define BSP_LED3_MUX_GPIO           (LWGPIO_MUX_E8_GPIO)
#define BSP_LED4_MUX_GPIO           (LWGPIO_MUX_E9_GPIO)
//#define BSP_SW1_MUX_GPIO            (LWGPIO_MUX_C6_GPIO)
#define BSP_SW2_MUX_GPIO            (LWGPIO_MUX_D6_GPIO)
//#define BSP_ACCEL_MUX_GPIO          (LWGPIO_MUX_A6_GPIO)
...
#define BSP_SDCARD_GPIO_DETECT              (GPIO_PORT_B | GPIO_PIN20)
#define BSP_SDCARD_GPIO_PROTECT             (GPIO_PORT_B | GPIO_PIN21)
#define BSP_SDCARD_DETECT_MUX_GPIO          (LWGPIO_MUX_B20_GPIO)
...
//    #elif BSPCFG_ENABLE_TTYE
//        #define BSP_DEFAULT_IO_CHANNEL                        "ttye:"
//        #define BSP_DEFAULT_IO_CHANNEL_DEFINED
//	#else
        #define BSP_DEFAULT_IO_CHANNEL                        NULL
//		#warning Standard I/O undefined
//    #endif
//#else
